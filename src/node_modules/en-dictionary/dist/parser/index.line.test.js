...
const index_line_1 = __importDefault(require("./index.line"));
describe("Test parsing an index line", () => {
    test("Parse an index line", () => {
        let item = new index_line_1.default().parse("  7 database and its documentation for any purpose and without fee or  ");
        expect(item.isComment).toBe(true);
        item = new index_line_1.default().parse("advanced a 8 1 & 8 8 01840121 00819526 01876261 01211296 01208738 00816839 00412171 00198383");
        ...
        item = new index_line_1.default().parse(".38-calibre a 1 1 \\ 1 0 03146602  ");
        ...
        item = new index_line_1.default().parse("10th a 1 1 & 1 0 02203373  ");
        ...
        item = new index_line_1.default().parse("a_posteriori a 2 3 ! & ^ 2 0 00139126 00859350  ");
        ...
        item = new index_line_1.default().parse("around_the_bend a 1 1 & 1 0 02074929  ");
        ...
        item = new index_line_1.default().parse("armed a 3 3 ! & ; 3 1 00142407 00146210 00144877  ");
