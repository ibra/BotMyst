...
const pos = new Map()
    ...
    .set('r', 'adverb');
const pointerSymbolsNoun = new Map()
    .set("!", "Antonym")
    .set("@", "Hypernym")
...
const pointerSymbolsVerb = new Map()
    .set("!", "Antonym")
    .set("@", "Hypernym")
    .set("~", "Hyponym")
    .set("*", "Entailment")
    ...
    .set(";r", "Domain of synset - REGION")
    .set(";u", "Domain of synset - USAGE");
const pointerSymbolsAdjective = new Map()
    .set("!", "Antonym")
    .set("&", "Similar to")
