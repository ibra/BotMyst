      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            trelloError = new Discord.MessageEmbed().setAuthor('I was unable to send this suggestion!').setColor(FailureColor).setDescription('Your suggestion contains more than 100 characters in it!').setTimestamp(Date.now());
          ...
          case 7:
            ...
            trelloSuccess = new Discord.MessageEmbed().setAuthor('The suggestion has been added!').setURL('https://trello.com/b/8wf6nzML/codemyst-revival').setColor(SuccessColor).setDescription('The following suggestion has been added to the developers trello list!: ' + suggestion).setTimestamp(); //Send the embed
