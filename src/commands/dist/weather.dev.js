          ...
          case 0:
            ...
            weather.find({
              ...
              if (!args[0]) {
                ...
                var errorEmbed = new Discord.MessageEmbed().setAuthor('> Error 400').setDescription("Please Specify a location!").setFooter("e.g: >weather Brisbane [Returns Weather Forecast]").setColor(FailureColor);
              ...
              if (result === undefined || result.length === 0) {
                ...
                var _errorEmbed = new Discord.MessageEmbed().setAuthor('> Error 404').setDescription('Couldnt find the location you provided!').setFooter('Check your spelling in case of an error, or make sure you are providing the name of a valid location / area, and not a country!').setColor(FailureColor);
