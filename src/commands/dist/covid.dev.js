          ...
          case 5:
            ...
            if (args[0] === "all") {
              ...
              fetch("https://covid19.mathdro.id/api/countries/".concat(countries)).then(function (response) {
                ...
                var embed = new Discord.MessageEmbed().setTitle("COVID-19 Stats for **".concat(country, "**")).addField('Confirmed Cases', confirmed).addField('Recovered', recovered).addField('Deaths', deaths).setColor(SuccessColor).setTimestamp(Date.now());
                message.channel.send(embed);
              })["catch"](function (e) {
