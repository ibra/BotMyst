      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            lmgtfyEmbed = new Discord.MessageEmbed().setTitle("Heres what i could find for: " + search).setURL('https://lmgtfy.com/?q=' + replaced).setTimestamp(Date.now()).setColor(SuccessColor); //Send the embed.
